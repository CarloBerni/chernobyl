...
},{"process":"../node_modules/process/browser.js"}],"services/jquery.scrollify.min.js":[function(require,module,exports) {
var define;
...
!function (a, b) {
  ...
  }) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b(require("jquery"), a, a.document) : b(jQuery, a, a.document);
  ...
  var h,
    ...
    D = !0, a.easing.easeOutExpo = function (a, b, c, d, e) {
      ...
      calculateNearest: function calculateNearest(a, b) {
        v = u.scrollTop();
      ...
      wheelHandler: function wheelHandler(c) {
        if (z === !0) return !0;
      ...
      keyHandler: function keyHandler(a) {
      ...
      touchHandler: function touchHandler(b) {
        if (z === !0) return !0;
  ...
  return H.move = function (b) {
    ...
    return !!D && void ("object" == _typeof(c) ? (G = a.extend(G, c), l.handleUpdate()) : b.console && console.warn("Scrollify warning: setOptions expects an object."));
  }, a.scrollify = H, H;
});
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","services/jquery.scrollify.min.js"], null)
//# sourceMappingURL=/jquery.scrollify.min.99723d58.js.map
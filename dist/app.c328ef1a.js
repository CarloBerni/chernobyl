...
module.exports = {
  ...
  "fillette": require("./fillette.mp4"),
  "igor": require("./igor.mp4"),
  "liquidateur": require("./liquidateur.mp4"),
  "outroIgor": require("./outroIgor.mp4")
};
},{"./Intro.mp4":"assets/images/Intro.mp4","./fillette.mp4":"assets/images/fillette.mp4","./igor.mp4":"assets/images/igor.mp4","./liquidateur.mp4":"assets/images/liquidateur.mp4","./outroIgor.mp4":"assets/images/outroIgor.mp4"}],"data.js":[function(require,module,exports) {
"use strict";
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "container__text" }, [
            ...
            _vm.$route.params.id
              ? _c("p", { staticClass: "big__texte" }, [
                  _vm._v(_vm._s(_vm.step.sentence__8))
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm.$route.params.id
              ? _c("p", { staticClass: "big__texte" }, [
                  _vm._v(_vm._s(_vm.step.sentence__9))
                ])
              : _vm._e(),
            _vm._v(" "),
            _vm.$route.params.id
              ? _c("p", { staticClass: "big__texte" }, [
                  _vm._v(_vm._s(_vm.step.sentence__10))
                ])
              : _vm._e()
          ])
        ]
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "bar" }, [_c("span")])
  }
]
render._withStripped = true

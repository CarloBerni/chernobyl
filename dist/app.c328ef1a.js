...
},{"./../assets/images/TCHERNOBYL 1.png":[["TCHERNOBYL 1.f03530ef.png","assets/images/TCHERNOBYL 1.png"],"assets/images/TCHERNOBYL 1.png"],"./../assets/images/Pripyat__bg.png":[["Pripyat__bg.1b1d0db2.png","assets/images/Pripyat__bg.png"],"assets/images/Pripyat__bg.png"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"components/Intro.vue":[function(require,module,exports) {
"use strict";
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"components/Map.vue":[function(require,module,exports) {
"use strict";
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/vue-fullpage.js/dist/vue-fullpage.js":[function(require,module,exports) {
var define;
/*!
...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if (typeof exports === 'object') exports["VueFullpageJs"] = factory();else root["VueFullpageJs"] = factory();
})(this, function () {
  return (
    /******/
    function (modules) {
        ...
        return Ut.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
          ...
          function K(e, t) {
            ...
            if (g.autoScrolling && !g.scrollBar) Nn(r, {
              ...
              "touch-action": "none"
            }), null != n && Rt(n.offsetTop);else if (Nn(r, {
              overflow: "visible",
              height: "initial"
          ...
          function xt(e, t) {
            ...
            if (null != n) {
              var o,
                  r,
                  i,
                  l = (null == (i = Rn(mn + '[data-anchor="' + (o = t) + '"]', r = n)[0]) && (o = void 0 !== o ? o : 0, i = Rn(mn, r)[o]), i);
          ...
          function Rt(e) {
            var t = Math.round(e);
            if (g.css3 && g.autoScrolling && !g.scrollBar) wt("translate3d(0px, -" + t + "px, 0px)", !1);else if (g.autoScrolling && !g.scrollBar) Nn(y, {
              top: -t + "px"
          ...
          function Xt(t, n, o, r) {
            var e,
                i = (e = t).self != Ut && zn(e, bn) ? e.scrollLeft : !g.autoScrolling || g.scrollBar ? eo() : e.offsetTop,
                l = n - i,
                a = 0;
            z = !0;
      ...
      exports.default = {
        methods: {
          ...
          emitEvent: function emitEvent(name, args) {
            ...
            this.$emit.apply(this, [camelToKebab(name)].concat(_toConsumableArray(args))); // Run event's handler with non Vue way
...
var _default = {
  ...
  }, _defineProperty(_methods, "afterLoad", function afterLoad() {
    console.log("Emitted 'after load' event.");
  }), _defineProperty(_methods, "addSection", function addSection(e) {
    var newSectionNumber = document.querySelectorAll(".fp-section").length + 1; // creating the section div
  ...
  }), _defineProperty(_methods, "removeSection", function removeSection() {
    var sections = document.querySelector("#fullpage").querySelectorAll(".fp-section");
    var lastSection = sections[sections.length - 1]; // removing the last section

    lastSection.parentNode.removeChild(lastSection); // removing the last anchor

    this.options.anchors.pop(); // removing the last item on the sections menu
  ...
  mounted: function mounted() {
    ...
    _axios.default.get("https://api.coindesk.com/v1/bpi/currentprice.json").then(function (response) {
      return _this.carlo = response.data.bpi;
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "section" }, [
            _c("h3", [_vm._v(_vm._s(_vm.carlo))])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "section" }, [
            _c("div", { staticClass: "slide" }, [
              _c("h3", [_vm._v("Slide 2.1")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "slide" }, [
              _c("h3", [_vm._v("Slide 2.2")])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "slide" }, [
              _c("h3", [_vm._v("Slide 2.3")])
            ])
          ]),
          _vm._v(" "),
          _c(
            ...
            [
              ...
              _c(
                "router-link",
                { staticClass: "button", attrs: { to: "/timeline" } },
                [_vm._v("suivant")]
              )
            ],
            1
...
},{"axios":"../node_modules/axios/index.js","vue-fullpage.js":"../node_modules/vue-fullpage.js/dist/vue-fullpage.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"components/Timeline.vue":[function(require,module,exports) {
"use strict";
...
},{"vue":"../node_modules/vue/dist/vue.common.js","./router":"router.js","./assets/scss/styles.scss":"assets/scss/styles.scss","vue-fullpage.js":"../node_modules/vue-fullpage.js/dist/vue-fullpage.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
